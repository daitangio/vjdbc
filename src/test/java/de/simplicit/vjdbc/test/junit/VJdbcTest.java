...
public abstract class VJdbcTest extends TestCase {
	...
	protected void setUp() throws Exception {
		if (System.getSecurityManager() == null) {
			...
			Logger.getLogger(getClass()).info("Security manager ok");
		}
	...
	protected Connection createVJdbcConnection() throws SQLException, InstantiationException, IllegalAccessException, ClassNotFoundException {
		...
		// GG WAS Connection conn = DriverManager.getConnection(connectionUrl + "#" + getVJdbcDatabaseShortcut(), getVJdbcProperties());
